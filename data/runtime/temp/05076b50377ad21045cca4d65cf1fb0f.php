<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:43:"themes/simpleboot3/user\profile\center.html";i:1513602023;s:35:"themes/simpleboot3/public\head.html";i:1513602023;s:39:"themes/simpleboot3/public\function.html";i:1513602023;s:34:"themes/simpleboot3/public\nav.html";i:1513602023;s:38:"themes/simpleboot3/public\usernav.html";i:1513602023;s:37:"themes/simpleboot3/public\footer.html";i:1513602023;s:38:"themes/simpleboot3/public\scripts.html";i:1513602023;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title><?php echo $user_login; ?> - 个人中心</title>
...
function __parse_navigation78f92641aa8ef3fb2d4422894cffdb43($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation78f92641aa8ef3fb2d4422894cffdb43';
...
if(''==''): ?>
    <?php echo __parse_navigation78f92641aa8ef3fb2d4422894cffdb43($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation78f92641aa8ef3fb2d4422894cffdb43($menus); ?>
    </>
<?php endif; ?>
				...
				<div class="tabs">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="one">
							...
							<div class="row">
								<div class="col-md-3">
								<a href="<?php echo url('profile/avatar'); ?>">
									<?php if(empty($avatar)): ?> 
										<img src="__TMPL__/public/assets/images/headicon_128.png" class="headicon" width="128" />
									<?php else: ?>
										<img src="__ROOT__/upload/<?php echo $avatar; ?>" class="headicon" width="128"/>
									<?php endif; ?>
								</a>
							</div>
							<div class="col-md-9">
								<div class="form-group">
									...
									<div><?php echo (isset($user_nickname) && ($user_nickname !== '')?$user_nickname:'未填写'); ?></div>
								</div>
								<div class="form-group">
									<label class="control-label" for="input-sex">性别</label>
									<div>
										<?php  $sexs=array("0"=>"保密","1"=>"程序猿","2"=>"程序媛");echo $sexs[$sex];  ?>
									</div>
								</div>
								<div class="form-group">
									<label class="control-label" for="input-birthday">生日</label>
									<div><?php echo date('Y-m-d',$birthday); ?></div>
								</div>
								<div class="form-group">
									<label class="control-label" for="input-user_url">个人网址</label>
									<div><?php echo (isset($user_url) && ($user_url !== '')?$user_url:'未填写'); ?></div>
								</div>
								<div class="form-group">
									<label class="control-label" for="input-signature">个性签名</label>
									<div><?php echo (isset($signature) && ($signature !== '')?$signature:'未填写'); ?></div>
								</div>
								<div class="form-group">
									<a href="<?php echo url('user/profile/edit'); ?>" class="btn btn-primary">编辑</a>
								</div>
							</div>
							</div>
						</div>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a3bbac1ade23,null,false);
 ?>
    <div class="links">
        <?php

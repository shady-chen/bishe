<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:43:"themes/simpleboot3/user\favorite\index.html";i:1513602023;s:35:"themes/simpleboot3/public\head.html";i:1513602023;s:39:"themes/simpleboot3/public\function.html";i:1513602023;s:34:"themes/simpleboot3/public\nav.html";i:1513602023;s:38:"themes/simpleboot3/public\usernav.html";i:1513602023;s:37:"themes/simpleboot3/public\footer.html";i:1513602023;s:38:"themes/simpleboot3/public\scripts.html";i:1513602023;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title><?php echo $user_login; ?>  - 我的收藏</title>
...
function __parse_navigation32d650d478caf3d7ea9e792663144747($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigation32d650d478caf3d7ea9e792663144747';
...
if(''==''): ?>
    <?php echo __parse_navigation32d650d478caf3d7ea9e792663144747($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigation32d650d478caf3d7ea9e792663144747($menus); ?>
    </>
<?php endif; ?>
									...
									<tr>
										...
										<td>
											<?php 
											 ...
											 ?>
											<a href="<?php echo cmf_url($url['action'],$url['param']); ?>">查看</a> |
											<a class="js-ajax-dialog-btn" href="<?php echo url('user/favorite/delete',array('id'=>$vo['id'])); ?>" data-msg="您确定要取消收藏吗？" data-ok="" data-cacel="取消">取消收藏</a>
										</td>
									</tr>
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a3bb96c98d34,null,false);
 ?>
    <div class="links">
        <?php
